...
ACDocument anima_cad_load_step(
    const char *path,
...
ACDocument anima_cad_make_test_document(
    double linearDeflectionM,
    double angularDeflectionRadians) {
  configureSignalHandling();
...
void anima_cad_free_document(ACDocument document) {
...
const char *anima_cad_open_cascade_version(void) { return OCC_VERSION_COMPLETE; }
