enum StudioPreferenceKey {
  ...
  static let viewportShowsPerformanceHUD = "viewportShowsPerformanceHUD"
  ...
  static let cadAmbientStrength = "cadAmbientStrength"
  static let cadShadowStrength = "cadShadowStrength"
  ...
  static let cadShowsFloorGrid = "cadShowsFloorGrid"
  static let cadShowsSolidFloor = "cadShowsSolidFloor"
  static let cadFloorColorHex = "cadFloorColorHex"
  static let cadBackgroundGradientEnabled = "cadBackgroundGradientEnabled"
  static let cadBackgroundBottomColorHex = "cadBackgroundBottomColorHex"
  static let cadMasterBrightness = "cadMasterBrightness"
  static let cadFloorGridSpacingMeters = "cadFloorGridSpacingMeters"
  static let cadFloorGridExtentMultiplier = "cadFloorGridExtentMultiplier"
  static let cadFloorGridMajorLineInterval = "cadFloorGridMajorLineInterval"
  static let cadFloorGridOpacity = "cadFloorGridOpacity"
