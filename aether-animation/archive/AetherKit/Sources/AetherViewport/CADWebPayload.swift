...
public struct CADWebGeometryPayload: Encodable {
  ...
  public init(document: CADGeometryDocument) {
...
public struct CADWebThemePayload: Encodable {
  ...
  public init(theme: CADViewportTheme) {
...
public struct CADWebNavigationPayload: Encodable {
  let orbit: [String]
  let pan: [String]
  ...
  public init(_ configuration: CADViewportNavigationConfiguration) {
